...
> SELECT ANIMAL\_TYPE, IFNULL\(NAME,'No name'\) AS NAME, SEX\_UPON\_INTAKE FROM ANIMAL\_INS

`coalesce` 사용

> SELECT ANIMAL\_TYPE, coalesce\(NAME,'No name'\) AS NAME, SEX\_UPON\_INTAKE FROM ANIMAL\_INS
...
![image-20201023235348062](https://github.com/midaslmg94/TILS/tree/6739e3301e39e528553c02436243e2a4e7f90e73/CodingTest/Algorithm_README/C:/Users/midas/AppData/Roaming/Typora/typora-user-images/image-20201023235348062.png)
